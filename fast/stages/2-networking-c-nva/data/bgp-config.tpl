...
!
 ...
 neighbor ${ip_neighbor_untrusted_0} ebgp-multihop 2
 neighbor ${ip_neighbor_untrusted_0} timers 20 60
 neighbor ${ip_neighbor_untrusted_1} remote-as ${asn_untrusted}
 neighbor ${ip_neighbor_untrusted_1} ebgp-multihop 2
 neighbor ${ip_neighbor_untrusted_1} timers 20 60
!
 neighbor ${ip_neighbor_trusted_0} remote-as ${asn_trusted}
 neighbor ${ip_neighbor_trusted_0} ebgp-multihop 2
 neighbor ${ip_neighbor_trusted_0} timers 20 60
 neighbor ${ip_neighbor_trusted_0} update-source ${ip_trusted}
 neighbor ${ip_neighbor_trusted_1} remote-as ${asn_trusted}
 neighbor ${ip_neighbor_trusted_1} ebgp-multihop 2
 neighbor ${ip_neighbor_trusted_1} timers 20 60
...
!
 ...
 neighbor ${ip_neighbor_cross_region_nva_0} timers 20 60
 ...
 neighbor ${ip_neighbor_cross_region_nva_1} timers 20 60
!
...
!
  network ${gcp_landing_trusted_primary}
  network ${gcp_landing_trusted_secondary}
  network ${gcp_dev_primary}
  network ${gcp_dev_secondary}
  network ${gcp_prod_primary}
  network ${gcp_prod_secondary}
  network 0.0.0.0/0
 exit-address-family
